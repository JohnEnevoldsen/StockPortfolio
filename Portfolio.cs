    ...
    public class Portfolio
    {
        ...
        public double TotalEarningsPercentage
        {
            get
            {
                ...
                double totalIntitialPrice = _stock1.InitialPrice+_stock2.InitialPrice+_stock3.InitialPrice;
                double totalCurrentPrice = _stock1.CurrentPrice+_stock2.CurrentPrice+_stock3.CurrentPrice;
                return totalCurrentPrice/totalIntitialPrice;
            }
        }
        #endregion
        ...
        public void UpdateCurrentPrices(double percent1, double percent2, double percent3)
        {
            ...
            _stock2.CurrentPrice = CalculateNewPrice(_stock1.CurrentPrice, percent2);
            _stock3.CurrentPrice = CalculateNewPrice(_stock1.CurrentPrice, percent3);
        }
